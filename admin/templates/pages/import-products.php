				...
				<div class="collapse-body">
					<table class="widefat wc-importer-error-log-table">
						...
						<tbody>
							...
							<tr>
								<th><code>Hoodie, ID 209, SKU woo-hoodie</code></th>
								<td>Error getting remote image http://localhost:8888/woocom-learning/wp-content/uploads/2021/08/hoodie-2.jpg. Error: A valid URL was not provided.</td>
							</tr>
							<tr>
								<th><code>Hoodie with Logo, ID 210, SKU woo-hoodie-with-logo</code></th>
								<td>Error getting remote image http://localhost:8888/woocom-learning/wp-content/uploads/2021/08/hoodie-with-logo-2.jpg. Error: A valid URL was not provided.</td>
							</tr>
							<tr>
								<th><code>T-Shirt, ID 211, SKU woo-tshirt</code></th>
								<td>Error getting remote image http://localhost:8888/woocom-learning/wp-content/uploads/2021/08/tshirt-2.jpg. Error: A valid URL was not provided.</td>
							</tr>
							<tr>
								<th><code>Beanie, ID 212, SKU woo-beanie</code></th>
								<td>Error getting remote image http://localhost:8888/woocom-learning/wp-content/uploads/2021/08/beanie-2.jpg. Error: A valid URL was not provided.</td>
							</tr>
						</tbody>
					</table>
				</div>
